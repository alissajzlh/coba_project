                            ...
                            <div class="dropdown-menu dropdown-menu-end w-md-450px">
                                ...
                                <div class="d-flex align-items-center border-bottom px-3 py-2">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <span class="text-muted fst-italic"><a href="https://themeon.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a3c2c2d1cccdfcc0cbc2d5c6d9e3c6dbc2ced3cfc68dc0ccce">[email&#160;protected]</a></span>
                                    </div>
                                </div>
                    ...
                    <div class="mainnav__categoriy py-3">
                        ...
                        <ul class="mainnav__menu nav flex-column">
                            ...
                            <!-- Link with submenu -->
                                ...
                                <a href="/home" class="mininav-toggle nav-link collapsed"><i class="demo-pli-home fs-5 me-2"></i>
                    ...
                    <div class="mainnav__categoriy py-3">
                        ...
                        <ul class="mainnav__menu nav flex-column">
                            ...
                            <li class="nav-item has-sub">
                                ...
                                <ul class="mininav-content nav collapse">
                                    <li class="nav-item">
                                        <a href="index" class="nav-link active">Static Tables</a>
                                    </li>
                                    <li class="nav-item">
