                            ...
                            <div class="dropdown-menu dropdown-menu-end w-md-450px">
                                ...
                                <div class="d-flex align-items-center border-bottom px-3 py-2">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <span class="text-muted fst-italic"><a href="https://themeon.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="751414071a1b2a161d1403100f35100d14180519105b161a18">[email&#160;protected]</a></span>
                                    </div>
                                </div>
                    ...
                    <div class="mainnav__categoriy py-3">
                        ...
                        <ul class="mainnav__menu nav flex-column">
                            ...
                            <li class="nav-item has-sub">
                                ...
                                <a href="#" class="mininav-toggle nav-link collapsed active"><i class="demo-pli-receipt-4 fs-5 me-2"></i>
                                ...
                                <ul class="mininav-content nav collapse">
                                    <li class="nav-item">
                                        <a href="static-tables/index.html" class="nav-link">Static Tables</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="gridjs/index.html" class="nav-link">Gridjs</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="tabulator/index.html" class="nav-link">Tabulator</a>
                                    </li>
